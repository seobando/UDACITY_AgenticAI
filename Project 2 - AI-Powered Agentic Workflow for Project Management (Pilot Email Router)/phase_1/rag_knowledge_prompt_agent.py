...
RAG_knowledge_prompt_agent = RAGKnowledgePromptAgent(  # TODO: 2 - Instantiate RAGKnowledgePromptAgent
...
embeddings = RAG_knowledge_prompt_agent.calculate_embeddings()  # TODO: 4 - Compute the knowledge_text the chunk embbedings
